...
namespace deprosa.Service.Automapper
{
    public class DeprosaAutoMapper : Profile
    {
        public DeprosaAutoMapper()
        {
        ...
        {
            Mapper.Initialize(e=> e.AddProfile(new DeprosaAutoMapper()));
        }
        ...
        private void ConfigureUserMapping()
        {
            Mapper.Initialize(m =>
            {
                ...
                .ForMember(e=>e.CompanyID,o=>o.MapFrom(f=>f.CompanyID))
            ...
            .ForAllOtherMembers(e => e.Ignore());
                ...
                .ForMember(e => e.ProductType, o => o.MapFrom(s => new ProductTypeDTO { ID = s.ProductType.ID, Name = s.ProductType.Name, Types = s.ProductType.Types}))
...
.ForMember(e => e.ID, o => o.MapFrom(s => s.ID))
                ...
                .ForMember(e => e.ProductType, o => o.MapFrom(s => new ProductType { ID = s.ProductType.ID, Name = s.ProductType.Name, Types = s.ProductType.Types}))
...
.ForMember(e => e.ProductType, o => o.MapFrom(s => new ProductTypeDTO { ID = s.ProductType.ID, Name = s.ProductType.Name }))
    .ForMember(e => e.CreatedBy, o => o.MapFrom(s => new AccountDTO { ID = s.CreatedBy.ID, FirstName = s.CreatedBy.FirstName, LastName = s.CreatedBy.LastName }))
      .ForMember(e => e.Images, o => o.MapFrom(s => (s.Images.Select(b => new ImageUploadDTO { FileName = b.Name, Content = b.ImageData}))))
.ForMember(e => e.Manufacturer, o => o.MapFrom(s => new ManufacturerDTO { ID = s.Manufacturer.ID, Name = s.Manufacturer.Name }))
