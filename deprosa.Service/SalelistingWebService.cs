...
namespace deprosa.Service
{
    ...
    public class SalelistingWebService 
    {
        ...
        public List<SaleListingDTO> GetPopular( int categoryid, bool issub)
        {
            var logged = issub
        ...
        public List<SaleListingDTO> GetForCompany(string vat, string sort, int page, string search)
        {
            ...
            try
            {
                ...
                var salelistings = Filter(salelistingsQuery, sort, page, Konstanter.PAGE_SIZE).ToList();
                return salelistings.Select(Mapper.Map<SaleListing, SaleListingDTO>).ToList();
            }
            catch (Exception)
            {
        ...
        public List<SaleListingDTO> GetFollowingSalelistings(int userid, string sort, int page, string search)
        {
            try
            {
                IQueryable<SaleListing> salelistingsQuery;
        ...
        public List<SaleListingDTO> GetForSubCategory(int id, string sort, int page, string search)
        {
            try
            {
                IQueryable<SaleListing> salelistingsQuery;
        ...
        public List<SaleListingDTO> GetForProductType(int id, string sort, int page, string search)
        {
            try
            {
                IQueryable<SaleListing> salelistingsQuery;
                ...
                var salelistings = Filter(salelistingsQuery, sort, page, Konstanter.PAGE_SIZE).Include(i => i.ProductType.Category).ToList();
                return salelistings.Select(Mapper.Map<SaleListing, SaleListingDTO>).ToList();
            }
            catch (Exception ex)
            {
        ...
        public List<SaleListingDTO> GetBySearchString(string search,  string sort, int page)
        {
        ...
        {
            return _saleListingRepository.Get(e => e.ID == id && e.Deleted == null).Include(i => i.ProductType).Single();
        }
